...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default:
          "bg-primary text-primary-foreground shadow-hud hover:brightness-110 hover:shadow-[0_0_30px_-6px_hsl(var(--hud-cyan)/0.6)]",
        violet:
          "bg-secondary text-secondary-foreground shadow-hud-violet hover:brightness-110",
        outline:
          "border border-border bg-transparent hover:border-cyan/60 hover:text-cyan",
