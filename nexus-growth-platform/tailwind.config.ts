...
/**
 * Cockpit / HUD design system.
 * Near-black base, cyan/violet/magenta accents.
...
const config: Config = {
  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        hud: "0 0 0 1px hsl(var(--hud-cyan) / 0.15), 0 0 40px -12px hsl(var(--hud-cyan) / 0.35)",
        "hud-violet": "0 0 0 1px hsl(var(--hud-violet) / 0.2), 0 0 40px -12px hsl(var(--hud-violet) / 0.4)",
      },
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
